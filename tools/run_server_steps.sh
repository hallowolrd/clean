...
OUTPUT_DIR="$PROJECT_ROOT/outputs_tkfac_server_steps/${DATASET}_${BACKBONE}"
...
# ------------------------------------------------------------
EXPERIMENTS=(
    "fisher_s10|4|tkfac_expert.py|--server-steps 10 --run-name tkfac_steps10"
    "fisher_s30|4|tkfac_expert.py|--server-steps 30 --run-name tkfac_steps30"
    "fisher_s50|4|tkfac_expert.py|--server-steps 50 --run-name tkfac_steps50"
    "fisher_s100|2|tkfac_expert.py|--server-steps 100 --run-name tkfac_steps100"
    "fisher_s200|2|tkfac_expert.py|--server-steps 200 --run-name tkfac_steps200"
)
